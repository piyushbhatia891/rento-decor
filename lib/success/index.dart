      ...
      child: Scaffold(
        ...
        body: Column(
          ...
          children: [
            ...
            Text("GREAT!",style: TextStyle(color: Colors.blue,fontWeight:FontWeight.bold,fontSize: 30.0,fontStyle: FontStyle.italic),),
            SizedBox(),
            Text("Your Order has been Placed.We will reach out to you shortly with your order",
