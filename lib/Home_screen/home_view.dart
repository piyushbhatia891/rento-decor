                  ...
                  child: Container(
                    ...
                    child: Row(
                      ...
                      children: [
                        ...
                        Text("Eazy Shop",style: TextStyle(color: Colors.white,fontSize: 20.0),),
                        Icon(Icons.notification_important,color: Colors.white,size: 16.0,),
                      ],
                    ),
                  ),
                );
...
class ListContainerWidget extends StatelessWidget {
  ...
  List<ServicesModel> model=[
    ...
    new ServicesModel(imageUrl: "assets/balloon.png",title: "Party Decoration"),
      ...
      children: [
        Container(
          ...
          child: Row(
              mainAxisAlignment: MainAxisAlignment.spaceBetween,
              children: [
                Text("Browse By Categories",style: TextStyle(color: Colors.black,fontSize: 18.0,fontWeight: FontWeight.bold),),
              ...
              child: Container(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Center(child: Text(model[index].title,textAlign: TextAlign.center,style: TextStyle(
                        fontWeight: FontWeight.bold,color: Colors.black,fontSize: 12.0),))
                  ],
                ),
              ),
            );
          },shrinkWrap: true,scrollDirection: Axis.horizontal,itemCount: 3),
        )
...
class ListContainerWidget2 extends StatelessWidget {
  ...
  List<ServicesModel> model=[
    new ServicesModel(imageUrl: "assets/chair.png",title: "ArmChair",subtitle: "200+ Products"),
    new ServicesModel(imageUrl: "assets/sofa.png",title: "Sofa Red",subtitle: "50+ Products"),
    new ServicesModel(imageUrl: "assets/sofa.png",title: "Sofa Red",subtitle: "80+ Products")
  ];
  @override
  Widget build(BuildContext context) {
    return Column(
      ...
      children: [
        Container(
          ...
          child: Row(
              mainAxisAlignment: MainAxisAlignment.spaceBetween,
              children: [
                Text("Browse By Offers", style: TextStyle(color: Colors.black,
                    fontSize: 16.0,
                ...
                child: Column(
                  ...
                  children: [
                    Container(
                      child: Column(
                        children: [
                          Image.asset(model[index].imageUrl,
                            fit: BoxFit.contain,),
                          Text(model[index].title,textAlign: TextAlign.center, style: TextStyle(
                              fontWeight: FontWeight.bold,
                              color: Colors.black,
                              fontSize: 12.0),),
                          Text(model[index].subtitle, textAlign: TextAlign.center,style: TextStyle(
                              fontWeight: FontWeight.bold,
                              color: Colors.grey.shade400,
                              fontSize: 12.0),)
                        ],
