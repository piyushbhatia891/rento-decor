          ...
          children: [
                    ...
                    Expanded(
                      child: Row(
                        children: [
                          ...
                          Text("Required Capacity",style: TextStyle(fontSize: 16.0),)
                        ],
                      ),
                    ),
                    InkWell(
                        ...
                        children: [
                          ...
                          Expanded(
                            child: Column(
                              ...
                              crossAxisAlignment: CrossAxisAlignment.center,
                              children: [
                                Text("Start Date",style: TextStyle(fontSize: 14.0),),
                                Text("11 / 10 /2020",style: TextStyle(fontSize: 14.0),)
                        ...
                        children: [
                          ...
                          Expanded(
                            child: Column(
                              ...
                              crossAxisAlignment: CrossAxisAlignment.center,
                              children: [
                                Text("End Date",style: TextStyle(fontSize: 12.0),),
                                Text("11 / 10 /2020",style: TextStyle(fontSize: 12.0),)
            ...
            Padding(
              ...
              child: Row(
                mainAxisAlignment: MainAxisAlignment.spaceBetween,
                children: [
                  Text("You May Also Like",style: TextStyle(fontSize: 12.0,color:Colors.grey,fontWeight: FontWeight.bold),),
