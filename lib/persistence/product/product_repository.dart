...
import 'package:eazy_shop/persistence/product/product_api_provider.dart';
import 'package:eazy_shop/persistence/search/search_api_provider.dart';

class ProductRepository {
  ProductApiProvider appApiProvider = ProductApiProvider();

  Future<Products> getProductById(id) => appApiProvider.getProductById(id);
}
